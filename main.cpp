...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "LifetionCoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.lifetioncoin.org", ""};
static const string testnet_seeds[] = {"testnet-seed.lifetioncoin.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 7977), true);
  }
  do {
